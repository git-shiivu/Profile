    ...
    <div className=" text-gray-800">
      ...
      <header className="bg-white shadow-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4 py-3">
          <h1 className="text-2xl font-bold max-w-[50vw]">Shivam Kumar</h1>
      ...
      <section className="bg-gradient-to-r from-blue-100 to-white py-[5vh] px-4">
        <div className="flex justify-around flex-wrap">
          <div className=''>
            <h2 className="text-4xl font-bold mb-4 max-sm:max-w-[100vw] sm:max-w-[50vw]">Hi, I'm Shivam Kumar</h2>
          ...
          <img src='./src/ShivamKumar.webp' alt="Shivam Kumar" className="max-sm:mt-[9vw] rounded-xl shadow-md max-sm:max-w-[55vw] sm:max-w-[25vw] inline-flex self-end hover:scale-105 duration-150 " />
        </div>
      </section>
      ...
      <section id="projects" className="py-16 px-4 bg-gray-100">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="inline-flex justify-center flex-wrap ">
            {projectLinks.map(i => (
              <div key={i} className="bg-white rounded-xl shadow-md p-5 max-sm:max-w-[100vw] max-sm:min-h-[40vh] sm:max-w-[30vw] sm:min-h-[50vh] m-[2vw] hover:scale-105 duration-150">
